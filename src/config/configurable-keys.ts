...
export const CONFIGURABLE_KEYS: Record<string, ConfigKeyMeta> = {
  ...
  "self_correction.enabled": {
    ...
    description: "Evaluate generated responses and regenerate when quality is below threshold",
    sensitive: false,
    hotReload: "instant",
  ...
  "self_correction.threshold": {
    type: "number",
    category: "Agent",
    label: "Correction Threshold",
    description: "Minimum quality score required before a response is accepted",
    sensitive: false,
    hotReload: "instant",
  ...
  "self_correction.max_iterations": {
    type: "number",
    category: "Agent",
    label: "Correction Iterations",
    description: "Maximum evaluate/reflect/regenerate cycles per response",
    sensitive: false,
    hotReload: "instant",
  ...
  "self_correction.tool_recovery_enabled": {
    type: "boolean",
    category: "Agent",
    label: "Tool Recovery",
    description: "Add recovery guidance after failed tool calls so the next attempt can adapt",
    sensitive: false,
    hotReload: "instant",
    validate: enumValidator(["true", "false"]),
    mask: identity,
