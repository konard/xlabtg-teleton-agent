...
## [0.8.42](https://github.com/konard/xlabtg-teleton-agent/compare/v0.8.41...v0.8.42) (2026-06-13)


### Features

* **a11y:** accessibility audit WCAG 2.1 AA + CI-проверка для WebUI ([0f8163c](https://github.com/konard/xlabtg-teleton-agent/commit/0f8163c7bf69ba48de0a5994d57fcfb232822034))
* add adaptive prompting engine ([6c2d005](https://github.com/konard/xlabtg-teleton-agent/commit/6c2d0053c0ba8a3f3a993cb8ffffdf901139777c))
* add adaptive prompting engine ([541b53f](https://github.com/konard/xlabtg-teleton-agent/commit/541b53f7eccf7ce5899afbd09fe581a94e3c7a87))
* add feedback learning system ([82c867a](https://github.com/konard/xlabtg-teleton-agent/commit/82c867aaf0f8ccf02e0ccbb330bdbe00f55ef229))
* add feedback learning system ([d526535](https://github.com/konard/xlabtg-teleton-agent/commit/d526535ffd919f4f73665abc727600b5e7d6a49b))
* add multi-agent network protocol ([602d9dc](https://github.com/konard/xlabtg-teleton-agent/commit/602d9dc77c9f5046baa7d79b3bfee24b01becc8c))
* add multi-agent network protocol ([d396888](https://github.com/konard/xlabtg-teleton-agent/commit/d396888a5e3e607c0f7a971c6e2848f0af4fcac6))
* **api:** code-first генератор OpenAPI 3.1 и Swagger UI ([60eba9b](https://github.com/konard/xlabtg-teleton-agent/commit/60eba9b684823b3ec9ff6d423b0aadb55d5cb87e))
* **backup:** резервное копирование, восстановление и откат миграций ([4ea07f4](https://github.com/konard/xlabtg-teleton-agent/commit/4ea07f4b57d67b64f2dc0ea417448db65247c5aa))
* **bench:** добавить набор бенчмарков производительности и регрессионный гейт ([0d275ef](https://github.com/konard/xlabtg-teleton-agent/commit/0d275ef6f5bdd719872b40ac7b17873f25e856f6))
* **bot:** route Telegram Bot API HTTPS through optional proxy ([3e297b1](https://github.com/konard/xlabtg-teleton-agent/commit/3e297b108c4ae6305585c988fff7d9c86a3ed300))
* **deploy:** добавить Docker Compose стек, Helm chart и multi-arch/cosign образ ([e530352](https://github.com/konard/xlabtg-teleton-agent/commit/e530352e5060c0b4961bf7e4a8ae8593dec89946)), closes [#498](https://github.com/konard/xlabtg-teleton-agent/issues/498)
* **mtproto:** show proxy health in config ([7518889](https://github.com/konard/xlabtg-teleton-agent/commit/75188893774a63155390d0d469f0ffbfc10741cd))
* **network:** show local agent on Network page + remote setup docs ([d79a73c](https://github.com/konard/xlabtg-teleton-agent/commit/d79a73ce46158a7c10d7e43d24b652bbe5695cf2))
* **network:** show local agent on the Network page and document remote agent setup ([8e587ec](https://github.com/konard/xlabtg-teleton-agent/commit/8e587ec02f738499f9d1f5f283ffb172226b7a9f))
* **observability:** добавить /metrics endpoint и Prometheus-метрики ([bce2db3](https://github.com/konard/xlabtg-teleton-agent/commit/bce2db35a67fef4a02cf4ae1d5d4cea4060ea784))
* **seo:** автоматизировать валидацию SEO-базлайна (sitemap/robots/noindex) ([98fc52f](https://github.com/konard/xlabtg-teleton-agent/commit/98fc52fc2418f93357c4a8f4d4304343fd76ef1f))
* **seo:** автоматизировать валидацию SEO-базлайна (sitemap/robots/noindex) ([9e2d2fc](https://github.com/konard/xlabtg-teleton-agent/commit/9e2d2fce439e6ec85474cf71b03e5b7e73c338c4))
...
* **site:** публичная маркетинговая лендинг-страница teletonagent.dev ([b343ed2](https://github.com/konard/xlabtg-teleton-agent/commit/b343ed2c459f7f97b89f2bdc2153b568423f10b9))
* **site:** публичная маркетинговая лендинг-страница teletonagent.dev ([305384e](https://github.com/konard/xlabtg-teleton-agent/commit/305384eb2d8cf9b2e47528329001867cc715aebc)), closes [#491](https://github.com/konard/xlabtg-teleton-agent/issues/491)
* **test:** добавить E2E-набор Playwright для WebUI ([d6a228a](https://github.com/konard/xlabtg-teleton-agent/commit/d6a228ae76379d9708fa3d389c8076bebd772691))
* **tts:** drop ffmpeg dependency for Telegram voice notes ([1041161](https://github.com/konard/xlabtg-teleton-agent/commit/1041161b09f40166db4d775dab4c98ee5bb7d7ac))
* **tts:** drop ffmpeg dependency for Telegram voice notes ([5d319d9](https://github.com/konard/xlabtg-teleton-agent/commit/5d319d92c96614f1127281cb5044a1dd19beafd3))
* **voice:** auto-convert WAV voicePath to OGG/Opus in telegram_send_voice ([e4da6d7](https://github.com/konard/xlabtg-teleton-agent/commit/e4da6d793c2c5e235e51572985c4701c614d2ae6))
* **voice:** автоконвертация WAV → OGG/Opus в telegram_send_voice ([d72cbe6](https://github.com/konard/xlabtg-teleton-agent/commit/d72cbe6c7bb305efe453088dc6328332d52beb5e))
* **webui:** externalize заголовки страниц и мастер Setup, CI-проверка паритета i18n и документация ([6cc83a1](https://github.com/konard/xlabtg-teleton-agent/commit/6cc83a1649fc2b163eaa888cd5d4a6c77a78da1c))
* **webui:** добавить инфраструктуру i18n (i18next), переключатель EN/RU, externalize навигации и логина ([1136b62](https://github.com/konard/xlabtg-teleton-agent/commit/1136b622d589eaae1e8881a7cab5bf673c1e00b2))


### Bug Fixes

* **a11y:** исправить контраст .step-label.active на тёмном фоне ([4503f6b](https://github.com/konard/xlabtg-teleton-agent/commit/4503f6b362fdd882922815515c9847874e3e38a1))
* **a11y:** устранить нарушения контраста WCAG 2.1 AA в WebUI ([c1ee77b](https://github.com/konard/xlabtg-teleton-agent/commit/c1ee77bfec114ff4eebef4949890ba835a6530e4))
...
* allow public webhook ingress through webui middleware ([fb274fb](https://github.com/konard/xlabtg-teleton-agent/commit/fb274fb695d801e22f1d658065bf2dd37e3f0dbd))
* allow signed V2 webhook ingress through WebUI middleware ([a531ee7](https://github.com/konard/xlabtg-teleton-agent/commit/a531ee7226ec338ca0c8c138d1b7df34c27601ab))
* **app:** keep WebUI/Management API alive when Telegram fails to start ([d83cf3e](https://github.com/konard/xlabtg-teleton-agent/commit/d83cf3ea860b7e2aef404b9bfb8b1c2beb364f28))
* **app:** keep WebUI/Management API alive when Telegram fails to start ([0adee07](https://github.com/konard/xlabtg-teleton-agent/commit/0adee072aee5ad53a91a4f8327f77e19c2b8c80a))
* **audio:** handle streaming WAV placeholder size 0xFFFFFFFF from Groq TTS ([69282a4](https://github.com/konard/xlabtg-teleton-agent/commit/69282a446a22276c2e5c1ea0426b26535043dc47))
* **audio:** handle streaming WAV placeholder size 0xFFFFFFFF from Groq TTS ([4c9147b](https://github.com/konard/xlabtg-teleton-agent/commit/4c9147b6d503365e5412687ebac14cc9d31ee3c7))
...
* **bot:** avoid blocking startup on Bot API getMe ([20b4739](https://github.com/konard/xlabtg-teleton-agent/commit/20b47398585de216bbf2047d39061bf93c775532))
* **bot:** avoid blocking startup on Bot API getMe ([c9cbc80](https://github.com/konard/xlabtg-teleton-agent/commit/c9cbc8012f8e982855103a6b06f8433188d024a6))
* **bot:** avoid blocking startup on GramJS MTProxy ([c529edc](https://github.com/konard/xlabtg-teleton-agent/commit/c529edc1c492103b25ea2f45d371b483a5a58ed0))
* **bot:** route Telegram Bot API HTTPS through optional proxy ([b648b5c](https://github.com/konard/xlabtg-teleton-agent/commit/b648b5c60644143e936e4e054ec2394255d3bcaf))
* **bot:** silence "Aborted delay" polling log on Ctrl+C shutdown ([62ffa30](https://github.com/konard/xlabtg-teleton-agent/commit/62ffa30272db203c330c9c412be90285ddf9f638))
* **bot:** silence "Aborted delay" polling log on Ctrl+C shutdown ([024d1a1](https://github.com/konard/xlabtg-teleton-agent/commit/024d1a120d097c41fa9de6f4c371ac0e36809cea))
...
* bound pipeline steps by run timeout ([ce776cf](https://github.com/konard/xlabtg-teleton-agent/commit/ce776cf7ac4936db71b0fedf3f0845771deb57dd))
* bound workflow call_api requests ([fb43e03](https://github.com/konard/xlabtg-teleton-agent/commit/fb43e036994311bdb656c8b98986965d618345ea))
* bound workflow call_api requests ([29ae1ca](https://github.com/konard/xlabtg-teleton-agent/commit/29ae1ca368e2f1a07f2b160c599b1f72bd620bef))
...
* **ci:** добавить generate:openapi, lint:openapi, compose.yaml и helm-чарт ([7b9736c](https://github.com/konard/xlabtg-teleton-agent/commit/7b9736cbaf9e2b07a0009c3239b11ccc314d12ef))
...
* **cli:** bind runtime home to explicit config ([3324154](https://github.com/konard/xlabtg-teleton-agent/commit/332415439e033c5f9a1dd331efc64ac817559a1b))
* **cli:** bind runtime home to explicit config ([c5fc5da](https://github.com/konard/xlabtg-teleton-agent/commit/c5fc5da5f9d40a22c3a37c7c9876df22cc528a17))
* complete autonomous tasks from reflection success ([02df3ff](https://github.com/konard/xlabtg-teleton-agent/commit/02df3ffddc3286700d42fa026ab5a174890a927b))
...
* dispatch agent network ingress tasks ([5ae9404](https://github.com/konard/xlabtg-teleton-agent/commit/5ae940443b002edbc39217af30b4459657c727e8))
* dispatch network ingress tasks ([e63d129](https://github.com/konard/xlabtg-teleton-agent/commit/e63d1292c1bdce519960226bb1f4fc903001eebe))
...
* enable semantic memory route search ([8274917](https://github.com/konard/xlabtg-teleton-agent/commit/82749174bebf113d0dad02bf85901f68b44f5622))
* enable semantic memory route search ([db22bcf](https://github.com/konard/xlabtg-teleton-agent/commit/db22bcf16cb9b0620fe10fc5fb89bad4a8b3b2c2))
* enforce agent network ingress trust ([12bbd6f](https://github.com/konard/xlabtg-teleton-agent/commit/12bbd6f83049241bf79675215b946e2ec16c4a0d))
...
* expose v2 routes in management api ([8cb4082](https://github.com/konard/xlabtg-teleton-agent/commit/8cb4082221b84a0a1d08a1e2b59e686522e36307))
...
* **memory:** add circuit breaker to UpstashSemanticVectorStore to suppress log spam on repeated failures ([96d1442](https://github.com/konard/xlabtg-teleton-agent/commit/96d1442ededbf0335772fb7250bf6b816498dea0))
* **memory:** circuit breaker for Upstash Vector search failures ([4b959a4](https://github.com/konard/xlabtg-teleton-agent/commit/4b959a42cd3aea33265973ef7f75a6ac5ff518a5))
...
* **memory:** восстановить внешние ключи автономных задач ([2d5f502](https://github.com/konard/xlabtg-teleton-agent/commit/2d5f5020f9743d8858fecd636e101db8ce7f2289))
...
* **mtproto:** fail over after getMe validation ([c1513d8](https://github.com/konard/xlabtg-teleton-agent/commit/c1513d8e57268ebeb295a1a5ce8e566c4a91d5fb))
* **mtproto:** fail over after getMe validation ([0f053a4](https://github.com/konard/xlabtg-teleton-agent/commit/0f053a4935c7d5274c85d458d8ae321a758c8a0c))
* **mtproto:** preserve proxy connection when getMe fails with auth error ([8cc2f50](https://github.com/konard/xlabtg-teleton-agent/commit/8cc2f50496091abe84bb9cf060bab7a670ee16a0))
* **mtproto:** preserve proxy when getMe fails with auth error ([73b2233](https://github.com/konard/xlabtg-teleton-agent/commit/73b22330e8fb98e074a1264a22c4d3de841eb780))
* **mtproto:** restore proxy auth recovery ([fd04def](https://github.com/konard/xlabtg-teleton-agent/commit/fd04defa02803a6d5bcbcc02c6443e4338b4d422))
* **mtproto:** route auth and show proxy health ([3f5bec3](https://github.com/konard/xlabtg-teleton-agent/commit/3f5bec38583472264e3097118e005ce4f81d86a9))
* **mtproto:** route setup auth through proxies ([5b6be7c](https://github.com/konard/xlabtg-teleton-agent/commit/5b6be7c6fdf7881f8241cfb6d405848d145dbf02))
* **mtproto:** support fake TLS proxy secrets ([3d9147d](https://github.com/konard/xlabtg-teleton-agent/commit/3d9147d29f771caaf9d1aa5716310edd13919cb8))
* **mtproto:** validate proxy status with session ([2246271](https://github.com/konard/xlabtg-teleton-agent/commit/22462718e439533f83f3f633ebb9590bcc73169d))
* **mtproto:** validate proxy status with session ([61bec17](https://github.com/konard/xlabtg-teleton-agent/commit/61bec175b5cfc696fbdad0f5dc6226e165c071ba))
* **network:** count local agent in network status totals ([b7cb0b7](https://github.com/konard/xlabtg-teleton-agent/commit/b7cb0b7874c2cd3b4e81c1708a92db7b3febd47a))
* **network:** count the local agent in network status totals ([b49d8a4](https://github.com/konard/xlabtg-teleton-agent/commit/b49d8a463055f7521827f6810201709d06157502))
* **network:** enforce ingress allowlist and recipient ([cb061b5](https://github.com/konard/xlabtg-teleton-agent/commit/cb061b5b8600b565e96dfd41d90dd7047e897756))
* **network:** enforce ingress allowlist and recipient ([7330bd2](https://github.com/konard/xlabtg-teleton-agent/commit/7330bd2ef10c2ce47bec9fc9b7d222f240aa1ed9))
* **network:** enforce ingress trust and recipient checks ([e5deafa](https://github.com/konard/xlabtg-teleton-agent/commit/e5deafa28c5ea9d0b424445e6c3edebb8d8df05a))
* pass saved session to MTProto proxy checks ([b7e94f8](https://github.com/konard/xlabtg-teleton-agent/commit/b7e94f80b652dd3b88044538805eb6720466f357))
* **pipeline:** bound steps by run timeout ([a824fec](https://github.com/konard/xlabtg-teleton-agent/commit/a824fec45357d66808364344310593da9f19b797))
* **pipeline:** wait for delegated agent results ([0fb42cc](https://github.com/konard/xlabtg-teleton-agent/commit/0fb42cc42d202a8efc4cf658483e956f7c9c4d83))
* **pipeline:** wait for delegated agent results ([f328032](https://github.com/konard/xlabtg-teleton-agent/commit/f32803290bee8eb0c6028f53331a5d10e09654bc))
...
* **plugins:** quiet checksum notices and resolve npm reliably ([329a83d](https://github.com/konard/xlabtg-teleton-agent/commit/329a83d5cbc0c2c911160b441a6f8407500239b6))
* **plugins:** reduce startup noise and resolve npm reliably ([872b03a](https://github.com/konard/xlabtg-teleton-agent/commit/872b03a87bc3eb490dd33b79a1557fe3ef469a31))
...
* reject replayed network messages ([6568a02](https://github.com/konard/xlabtg-teleton-agent/commit/6568a02aaf477fd64eee0be834a432ea3f480e19))
* reject replayed network messages ([f4e742a](https://github.com/konard/xlabtg-teleton-agent/commit/f4e742acdd27eff5c75587a18f4a695edabd0e58))
...
* **security:** обновить override axios до &gt;=1.16.1 для устранения high-уязвимости ([3bcf55e](https://github.com/konard/xlabtg-teleton-agent/commit/3bcf55ea988a8af110ac4ddb064cbbc5cb323590))
...
* send csrf token for agent controls ([69f2f2a](https://github.com/konard/xlabtg-teleton-agent/commit/69f2f2a12bca279e3e42042700c12f75ccef7721))
* send CSRF token for agent controls ([be7dff9](https://github.com/konard/xlabtg-teleton-agent/commit/be7dff9469df30ec2e4bd2dbbbb2218b57b165eb))
* **setup:** allow QR auth before config save ([1b887ee](https://github.com/konard/xlabtg-teleton-agent/commit/1b887eebc8ada265929cfef0bae382195f33ade8))
* **setup:** allow QR auth before config save ([f1b9495](https://github.com/konard/xlabtg-teleton-agent/commit/f1b94956e24fa7de665b454a773cb754cdd282f2))
* **tasks:** execute Saved Messages scheduled task triggers ([39ef5a8](https://github.com/konard/xlabtg-teleton-agent/commit/39ef5a81cfeba77bddff8db98eb2cacdefa52309))
* **tasks:** execute saved messages task triggers ([32b4925](https://github.com/konard/xlabtg-teleton-agent/commit/32b492547fc5bccb8b90cc31a23c7f0fb4a6ba61))
* **telegram:** preserve MTProxy metadata on reconnect ([4dbc0cf](https://github.com/konard/xlabtg-teleton-agent/commit/4dbc0cf45235b7c13e6990ff672d215342658c1d))
* validate MTProto proxy status with saved session ([dae5a7f](https://github.com/konard/xlabtg-teleton-agent/commit/dae5a7fc4c2996fa79894db4d55eedf012106885))
...
* **webui:** make hashed startup login link usable ([7d433a2](https://github.com/konard/xlabtg-teleton-agent/commit/7d433a29afaccdf188960d131b67264bdc1ced97))
* **webui:** make hashed startup login link usable ([90294ea](https://github.com/konard/xlabtg-teleton-agent/commit/90294ead65fec470805c25c21b8ce370e2561119))
...
* исправить внешние ключи автономных задач ([103fb1b](https://github.com/konard/xlabtg-teleton-agent/commit/103fb1b14311f0e231868e3a4c0aefae9d83d0eb))
...
* регенерировать docs/api-reference после добавления маршрута /metrics ([c49e9e0](https://github.com/konard/xlabtg-teleton-agent/commit/c49e9e0a99b62a5df71bc07165c4e324b6f6f414))
...
* Remove .gitkeep changes from initial commit ([9be2388](https://github.com/konard/xlabtg-teleton-agent/commit/9be2388ed6bc61b3bec4d6c50f1913a8cc0a0ce6))
* Remove .gitkeep changes from initial commit ([18c4bfc](https://github.com/konard/xlabtg-teleton-agent/commit/18c4bfc108b09ec8f8788dcf602d2b7c94b99848))
* Remove .gitkeep changes from initial commit ([7a54f9a](https://github.com/konard/xlabtg-teleton-agent/commit/7a54f9a846c86b316b2e9e41552ae32f43a9afe6))
* Remove .gitkeep changes from initial commit ([2cb2923](https://github.com/konard/xlabtg-teleton-agent/commit/2cb292344dc8f2a205497b9779a6258d5617ce32))
* Remove .gitkeep changes from initial commit ([8c96c69](https://github.com/konard/xlabtg-teleton-agent/commit/8c96c69705607584b2824ac4f84e3c1ff234523d))


### Documentation

* add bilingual WebUI user guide ([66c42e3](https://github.com/konard/xlabtg-teleton-agent/commit/66c42e3e0a214fd9cebf2979591d1a3585fd582b))
* add bilingual WebUI user guide ([1b6a3b2](https://github.com/konard/xlabtg-teleton-agent/commit/1b6a3b24128104186b63ca690bd22ea3372c815e))
* add feedback dashboard screenshot ([2b88415](https://github.com/konard/xlabtg-teleton-agent/commit/2b8841540611ede23f34cb458f02f98f790d2cd5))
* **api:** ссылки на OpenAPI-референс, тесты спеки и bump до 0.8.20 ([606bf16](https://github.com/konard/xlabtg-teleton-agent/commit/606bf169f42d57e698320fa2a4dd17277f5d0eb8))
* **audit:** add V2 work3 audit and follow-up issues ([fea2642](https://github.com/konard/xlabtg-teleton-agent/commit/fea264239089a7517064a9aeece055f347d8a821))
* **audit:** add V2 work3 audit report ([ea6b996](https://github.com/konard/xlabtg-teleton-agent/commit/ea6b99602efb80e978063d3d02e2afef2ad36ec7))
* **audit:** add V2 work3 hardening reports ([c7f69ea](https://github.com/konard/xlabtg-teleton-agent/commit/c7f69ea79f39f4f3e96725644b5fe2a04c890483))
* **audit:** add work3 V2 hardening report ([ae0f8ea](https://github.com/konard/xlabtg-teleton-agent/commit/ae0f8ea5e0663e2e60670b4772167360d4623b02))
* **audit:** link filed V2 follow-up issues ([69d64b0](https://github.com/konard/xlabtg-teleton-agent/commit/69d64b0343edefb0823a3519cd497818c295014d))
* **changelog:** задокументировать E2E-набор WebUI ([8240303](https://github.com/konard/xlabtg-teleton-agent/commit/82403031ff6cf8d58e3f3864aca4bd3ae0cfd2c7))
* document SemVer policy, commit conventions, and automated releases ([31efff5](https://github.com/konard/xlabtg-teleton-agent/commit/31efff54c9eca83fedf13db17361a9a8531123e7))
* **network:** add before/after screenshots for issue 471 ([8353e0f](https://github.com/konard/xlabtg-teleton-agent/commit/8353e0f65cfcfcf375644bc5a79741768b328b56))
* **readiness:** добавить анализ готовности продукта и SEO-ассеты ([48d0aa9](https://github.com/konard/xlabtg-teleton-agent/commit/48d0aa9df840d257d7c0959f392c5df0bb0fb388)), closes [#487](https://github.com/konard/xlabtg-teleton-agent/issues/487)
* **readiness:** добавить ссылки на созданные issue (R1–R14) ([d2fa0fa](https://github.com/konard/xlabtg-teleton-agent/commit/d2fa0fa462c8024762abfc31fb788a72fff11f63)), closes [#487](https://github.com/konard/xlabtg-teleton-agent/issues/487)
* **readiness:** обновить ссылки на issue — перенести в upstream xlabtg/teleton-agent ([c46264d](https://github.com/konard/xlabtg-teleton-agent/commit/c46264d257adc5c57805a3fc0cbe15b8b8587b8f))
...
* **readme:** синхронизировать версию форка с 0.8.20 ([903e4c3](https://github.com/konard/xlabtg-teleton-agent/commit/903e4c3d8e40499c8c039350a50cf6d363a47662))
* **readme:** синхронизировать версию форка с 0.8.21 ([b271e13](https://github.com/konard/xlabtg-teleton-agent/commit/b271e13b186c22b329ac98877cf6e1e9ecdbc42c))
...
* **readme:** синхронизировать строку версии с bump 0.8.20 ([b862ee6](https://github.com/konard/xlabtg-teleton-agent/commit/b862ee641bd38fe844aa3a812dbf8dec091ab577))
* **readme:** уточнить описание ffmpeg-free voice notes и Groq TTS WAV fix ([824b52f](https://github.com/konard/xlabtg-teleton-agent/commit/824b52f33e2ec4795f126e53717dfefe01802ce9))
* rewrite WebUI guide README, quick-start, dashboard, autonomous, tools, soul (EN+RU) ([7686c62](https://github.com/konard/xlabtg-teleton-agent/commit/7686c62bcea3ad22cfbd3a0212ce0903d930c58e))
* rewrite WebUI user guide for accuracy and bilingual parity ([64c95b4](https://github.com/konard/xlabtg-teleton-agent/commit/64c95b4919209180329e357fb89adf0754c4f142))
...
* **user-guide:** rewrite analytics, sessions, security, hooks, advanced, settings, troubleshooting, FAQ + relocate fresh login/setup screenshots ([968cf78](https://github.com/konard/xlabtg-teleton-agent/commit/968cf789908f7260b0b416382b31f271e814ab25))
...
* актуализировать README форка ([e02dd57](https://github.com/konard/xlabtg-teleton-agent/commit/e02dd57463b94b267881557ffe9ce0886c8c9679))
* добавить community health файлы ([f2cf7f6](https://github.com/konard/xlabtg-teleton-agent/commit/f2cf7f6d04a7065d7d3835e39f9d71725b513b03))
...
* **commitlint:** enforce Conventional Commits via husky commit-msg hook ([3419254](https://github.com/konard/xlabtg-teleton-agent/commit/341925452f46b32c7c28078e7306e8beabd2dff5))
* **openapi:** статические артефакты, redocly lint и CI-проверка ([29de222](https://github.com/konard/xlabtg-teleton-agent/commit/29de222fe05eb70136239d87f751f512748ddea3))
